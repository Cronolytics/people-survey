...
function Inicio() {
  ...
  useEffect(() => {
    ...
    api
      .get(`/pesquisas/pesquisas-simples?idEmpresa=${userID}`)
        ...
        <div className={isModalOpen ? "shadow-background-inicio" : "hide"}>
          <div className="card-modal-inicio">
            ...
            <div className="sub-titulo">
              <span>
                <b>Compartilhe este link para obter respostas.</b>
              </span>
            </div>
              ...
              <div className="modal-input-limiter">
                <div className="ui fluid labeled input">
                  ...
                  <input
                    readOnly
                    type="text"
                    value={`http://people-survey-app.azurewebsites.net/responder-pesquisa/id=${pesquisaSelecionada}`}
                  />
                </div>
              </div>
            </div>
